...
class ProductQueryControllerRestDocsTest extends RestDocsBase {
	...
	void getProductInfo_정상적인상황_상품상세조회성공() throws Exception {
		...
		given(productQueryService.getProductInfoById(eq(productId), any(AuthMember.class)))
			.willReturn(response);
	...
	void getProductSimpleInfo_정상적인상황_상품간단조회성공() throws Exception {
		...
		given(productQueryService.getProductSimpleInfoById(eq(productId)))
			.willReturn(response);
	...
	void getSoldProducts_정상적인상황_판매완료상품내역조회성공() throws Exception {
		...
		given(productQueryService.getSoldProductInfosByMemberId(eq(10L), any(Pageable.class)))
			.willReturn(page);
	...
	void getPurchasedProducts_정상적인상황_구매완료상품내역조회성공() throws Exception {
		...
		given(productQueryService.getPurchasedProductInfoByMemberId(eq(10L), any(Pageable.class)))
			.willReturn(page);
	...
	void getBiddingProducts_정상적인상황_입찰중인상품목록조회성공() throws Exception {
		...
		given(productQueryService.getBiddingProductInfoByMemberId(eq(10L), any(Pageable.class)))
			.willReturn(page);
	...
	void getSellingProducts_정상적인상황_경매중인상품목록조회성공() throws Exception {
		...
		given(productQueryService.getSellingProductInfoByMemberId(eq(10L), any(Pageable.class)))
			.willReturn(page);
	...
	void searchProduct_검색시도_상품검색성공() throws Exception {
		...
		given(productQueryService.searchProduct(any(SearchProductRequest.class))).willReturn(page);
